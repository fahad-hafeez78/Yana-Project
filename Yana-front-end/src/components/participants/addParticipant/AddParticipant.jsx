...
export default function AddParticipant() {
    ...
    const handleDeselection = (CPTcode, CPTtype) => {
        ...
        if (CPTtype === "MCpt") {
            updatedFormData.MCPT = "";
            updatedFormData.MAuthUnitsApproved = "";
            updatedFormData.MFrequency = "";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await dispatch(customersMiddleware.CreateCustomer(sanitizedFormData));
        ...
        <div className="bg-white p-5 rounded-2xl">
            <div className="flex flex-col font-['Poppins',sans-serif] gap-4">
                ...
                <div className='flex justify-between'>
                    <h1 className="text-[#959595] font-bold text-2xl">Add Participant</h1>
                        ...
                        <div className="flex flex-wrap gap-[10px] mb-[15px] w-full">
                            <div className="flex-1 min-w-[1px]">
                                <label htmlFor="MedicaidID" className="block font-bold ">
                                    Medical ID <span className="text-red-600">*</span>
                                </label>
                                <CustomInput
                                    id="MedicaidID"
                                    name="MedicaidID"
                                ...
                                <div className="mb-[10px] flex-1">
                                    ...
                                    <div className="flex gap-[5px]">
                                        {["W1759", "W1760", "W1764"].map((CPTcode) => {
                                            ...
                                            const authUnits = formData?.MAuthUnitsApproved || 0
                                            const frequency = formData?.MFrequency || 'Weekly'
                                            return (
                                                <button
                                                    type="button"
