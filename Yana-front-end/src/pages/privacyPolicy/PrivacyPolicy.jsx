            ...
            {!isAccepted ? (
              <div className="mt-6 flex space-x-4">
                <button
                  ...
                  className="flex-1 bg-custom-blue text-white py-3 rounded-lg hover:bg-blue-800 transition-colors"
                >
              ...
              <div className="mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg text-green-800 text-center">
