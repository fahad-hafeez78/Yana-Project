          ...
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-2 border-b">
                  ...
                  {/* <div className="flex items-center">
                    ...
                    <span className="ml-1 text-lg">{item?.rating || "5"}</span>
                  </div> */}
                </div>

                {/* <div>
                  <h2 className="text-lg font-semibold mb-2">Vendor</h2>
                  <p className="text-red-600 font-medium">{item?.vendorId?.name}</p>
                </div> */}
            ...
            <div className="lg:w-1/2 space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <ul className="space-y-1 pl-5">
                  {item?.allergies?.length > 0 ? (
                    item.allergies.map((warning, index) => (
                      <li key={index} className="list-disc text-gray-dark">
                        {warning}
                      </li>
                    ))
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <ul className="space-y-1 pl-5">
                  {item?.nutrition_info?.length > 0 ? (
                    item.nutrition_info.map((nutrition, index) => (
                      <li key={index} className="list-disc text-gray-dark">
                        {nutrition}
                      </li>
                    ))
