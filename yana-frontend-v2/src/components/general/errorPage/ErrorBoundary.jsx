...
// SVG Imports
import ForbiddenSVG from "../../../assets/customIcons/errorIcons/statuscode403.svg";
import NotFoundSVG from "../../../assets/customIcons/errorIcons/statuscode404.svg";
import ServerErrorSVG from "../../../assets/customIcons/errorIcons/statuscode500.svg";
  ...
  return (
    <div role="alert" className="flex items-center justify-center bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col items-center space-y-4">   
        <h1 className="text-8xl font-bold text-red">{errorDetails.title || "Error"}</h1>
        ...
        <button
          ...
          className="bg-blue border text-white px-10 py-1 rounded-full text-lg flex items-center justify-center"
        >
          Go Home
        </button>
      </div>
...
export const NotFoundPage = () => {
  return (
    <div role="alert" className="flex items-center justify-center bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col items-center space-y-4">   
        <h1 className="text-8xl font-bold text-red">{customMessages[404].title}</h1>
