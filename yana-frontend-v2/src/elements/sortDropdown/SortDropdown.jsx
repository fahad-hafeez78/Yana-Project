...
const SortDropdown = ({ Data, setData, options }) => {
  const [selectedSort, setSelectedSort] = useState(options[0].value || ""); // Initialize with the first option
  ...
  return (
    <div className="relative">
      <CustomDropdown
        ...
        className="block appearance-none w-full bg-gray-100 text-gray-600 py-1.5 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-gray-200 focus:border-gray"
